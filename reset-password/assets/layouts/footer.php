            ...
            <div class="row">
                ...
                <div class="col-sm-3 my-3">
                    <div class="social-networks">
                        <a href="techst,net" class="twitter" target="_blank">
                            <i class="fab fa-github"></i>
                        </a>
                        <a href="inkedi.com/in/muhammadsaadhussaini/" class="facebook" target="_blank">
                            <i class="fab fa-linkedin"></i>
                        </a>
                    </div>
                    <a class="btn btn-default" href="mailto:toxicking2659@gmail.com" target="_blank">Email Me</a>
                </div>
            </div>
        </div>
